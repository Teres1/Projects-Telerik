...
public class DebitCard extends BankCard implements
        BillsPayable, CardValidityCheckable, CashFromATMWithdrawable {
    public DebitCard(String name, String idOrBulstat, int incomesMonthly, int annualMaintenance, double withdrawTax, double cardBalance) {
